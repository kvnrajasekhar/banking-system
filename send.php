...
<body>
    ...
    <!-- header with newone and sql code -->
    ...
    <div class="container my-3">
        <form action="<?php $_PHP_SELF ?>" method="post">
            <div class="mb-3">
                ...
                <div id="emailHelp" class="form-text">The Above Name is Your Account Name.</div>
            </div>
            <div class="mb-3">
                <label for="To" class="form-label">To</label>
                <input type="text" class="form-control" id="To" name="to" required />
                <div id="emailHelp" class="form-text">Enter The Reciever Name.</div>
            </div>
            <div class="mb-3">
                <label for="Amount" class="form-label">Amount</label>
                <input type="number" class="form-control" id="Amt" name="amount" required />
                <div id="emailHelp" class="form-text">Enter Amount in Digits like 10,000 etc.,,</div>
            </div>
